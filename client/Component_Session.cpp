...
void	Component_Session::RegisteredRequests()
{
  ...
  (*_registeredRequests)[SESSION_AUTHRESPONSE_OK] = 
    new Request(SESSION_AUTHRESPONSE_OK, RECV, "AUTHRESPONSE_OK", RESPONSETONOTHING);

  (*_registeredRequests)[SESSION_AUTHRESPONSE_NOK_BADAUTH] = 
    new Request(SESSION_AUTHRESPONSE_NOK_BADAUTH, RECV, "AUTHRESPONSE_NOK_BADAUTH", RESPONSETONOTHING);

  (*_registeredRequests)[SESSION_AUTHRESPONSE_NOK_DUPLICATE] = 
    new Request(SESSION_AUTHRESPONSE_NOK_DUPLICATE, RECV, "AUTHRESPONSE_NOK_DUPLICATE", RESPONSETONOTHING);
