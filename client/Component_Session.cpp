...
void	Component_Session::RegisteredRequests()
{
  ...
  (*_registeredRequests)[SESSION_AUTHREQUEST] = 
    new Request(SESSION_AUTHREQUEST, SEND, "AUTHREQUEST", NORETRY);
  ...
  (*_registeredRequests)[SESSION_AUTHRESPONSE_OK] = 
    new Request(SESSION_AUTHRESPONSE_OK, RECV, "AUTHRESPONSE_OK", RESPONSE_TO_NOTHING);

  (*_registeredRequests)[SESSION_AUTHRESPONSE_NOK_BADAUTH] = 
    new Request(SESSION_AUTHRESPONSE_NOK_BADAUTH, RECV, "AUTHRESPONSE_NOK_BADAUTH", RESPONSE_TO_NOTHING);

  (*_registeredRequests)[SESSION_AUTHRESPONSE_NOK_DUPLICATE] = 
    new Request(SESSION_AUTHRESPONSE_NOK_DUPLICATE, RECV, "AUTHRESPONSE_NOK_DUPLICATE", RESPONSE_TO_NOTHING);
