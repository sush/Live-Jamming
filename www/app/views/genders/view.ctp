...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(sprintf(__('Edit %s', true), __('Gender', true)), array('action' => 'edit', $gender['Gender']['id'])); ?> </li>
		<li><?php echo $this->Html->link(sprintf(__('Delete %s', true), __('Gender', true)), array('action' => 'delete', $gender['Gender']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $gender['Gender']['id'])); ?> </li>
		<li><?php echo $this->Html->link(sprintf(__('List %s', true), __('Genders', true)), array('action' => 'index')); ?> </li>
