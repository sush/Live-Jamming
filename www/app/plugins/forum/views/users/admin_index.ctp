...
<tr>
	<td class="ar">
		...
		<?php echo $form->input('login', array('div' => false, 'label' => '('. __d('forum', 'Login', true) .'): ')); ?>
...
<div class="forumWrap">
    ...
    <tr<?php if ($counter % 2) echo ' class="altRow"'; ?>>
        ...
        <td><?php echo $html->link($user['User']['login'], array('action' => 'edit', $user['User']['id'], 'admin' => true)); ?></td>
