...
<tr>
	<td class="ar"><?php echo $form->input('login', array('div' => false, 'label' => __d('forum', 'Search Users (Login)', true) .': ')); ?></td>
...
<div class="forumWrap">
    ...
    <tr>
        <th><?php echo $paginator->sort(__d('forum', 'Login', true), 'User.login'); ?></th>
    ...
    <tr<?php if ($counter % 2) echo ' class="altRow"'; ?>>
        <td><?php echo $html->link($user['User']['login'], array('action' => 'profile', $user['User']['id'])); ?></td>
