...
<div class="forumWrap">
    ...
    <tr>
        ...
        <th><?php echo $paginator->sort(__d('forum', 'Reported By', true), 'Reporter.login'); ?></th>
    ...
    <tr<?php if ($counter % 2) echo ' class="altRow"'; ?>>
        ...
        <td><?php echo $html->link($report['User']['login'], array('controller' => 'users', 'action' => 'edit', $report['User']['id'], 'admin' => true)); ?></td>
