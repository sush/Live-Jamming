...
<div class="forumWrap">
    ...
    <tr id="staff_<?php echo $user['Access']['id']; ?>">
        <td><strong><?php echo $html->link($user['User']['login'], array('controller' => 'users', 'action' => 'edit', $user['User']['id'], 'admin' => true)); ?></strong></td>
...
<div class="forumWrap">
    ...
    <tr id="mod_<?php echo $user['Moderator']['id']; ?>">
        <td><strong><?php echo $html->link($user['User']['login'], array('controller' => 'users', 'action' => 'edit', $user['Moderator']['id'], 'admin' => true)); ?></strong></td>
