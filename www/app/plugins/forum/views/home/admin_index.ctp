...
<div class="forumWrap">
    ...
    <tr>
    	...
    	<td class="ac"><?php echo $html->link($newestUser['User']['login'], array('controller' => 'users', 'action' => 'edit', $newestUser['User']['id'], 'admin' => true)); ?></td>
    </tr>
    </table>
</div>	
    ...
    <tr<?php if ($counter % 2) echo ' class="altRow"'; ?>>
    	...
    	<td>	
        	<?php if ($report['Report']['itemType'] == 'topic') {
				...
				echo $html->link($report['User']['login'], array('controller' => 'users', 'action' => 'edit', $report['User']['id'], 'admin' => true));
			} else if ($report['Report']['itemType'] == 'post') {
				echo $report['Post']['content'];
			} ?>
        </td>
        <td><?php echo $html->link($report['Reporter']['login'], array('controller' => 'users', 'action' => 'edit', $report['Reporter']['id'], 'admin' => true)); ?></td>
...
<div class="forumWrap">
    ...
    <tr<?php if ($counter % 2) echo ' class="altRow"'; ?>>
        <td><?php echo $html->link($user['User']['login'], array('controller' => 'users', 'action' => 'edit', $user['User']['id'], 'admin' => true)); ?></td>
