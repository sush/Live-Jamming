...
class ReportsController extends ForumAppController {
	...
	public function admin_index() {
		$this->paginate['Report']['contain'] = array('Reporter.id', 'Reporter.login', 'Topic.title', 'Topic.id', 'Post', 'User.id', 'User.login');
	...
	public function admin_topics() {
		...
		$this->paginate['Report']['contain']= array('Reporter.id', 'Reporter.login', 'Topic.title', 'Topic.id');
	...
	public function admin_posts() {
		...
		$this->paginate['Report']['contain'] = array('Reporter.id', 'Reporter.login', 'Post');
	...
	public function admin_users() {
		...
		$this->paginate['Report']['contain']= array('Reporter.id', 'Reporter.login', 'User.id', 'User.login');
