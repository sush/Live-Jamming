...
#define PROTOV1_JAM_TIMESTAMP_OFF		PROTOV1_JAM_AUDIODATALEN_OFF + PROTOV1_JAM_AUDIODATALEN_SIZE
#define PROTOV1_JAM_TIMESTAMP_SIZE		24

#define PROTOV1_JAM_MIXCOUNT_OFF		PROTOV1_JAM_TIMESTAMP_OFF + PROTOV1_JAM_TIMESTAMP_SIZE
