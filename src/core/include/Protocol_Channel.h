...
#define PROTOV1_CHANNEL_CHANNELID_SIZE 16
...
#define PROTOV1_CHANNEL_START_OF_DATA (PROTOV1_START_OF_DATA + \
				       BINARYTOBYTE_LEN(PROTOV1_CHANNEL_CLIENTSESSIONID_OFF + PROTOV1_CHANNEL_CLIENTSESSIONID_SIZE))
