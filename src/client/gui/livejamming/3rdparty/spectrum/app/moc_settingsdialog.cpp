...
int SettingsDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: windowFunctionChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: inputDeviceChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: outputDeviceChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
