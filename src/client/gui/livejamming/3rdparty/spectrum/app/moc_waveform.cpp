...
**
** Created: Fri Jul 16 17:15:03 2010
...
static const char qt_meta_stringdata_Waveform[] = {
    "Waveform\0\0length\0dataLengthChanged(qint64)\0"
...
int Waveform::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: dataLengthChanged((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        case 1: positionChanged((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 2;
    }
