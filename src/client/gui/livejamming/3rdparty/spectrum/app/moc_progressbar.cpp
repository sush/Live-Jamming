...
**
** Created: Fri Jul 16 17:15:00 2010
...
static const char qt_meta_stringdata_ProgressBar[] = {
    "ProgressBar\0\0bufferSize\0"
    "bufferDurationChanged(qint64)\0"
...
int ProgressBar::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: bufferDurationChanged((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        case 1: recordPositionChanged((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        case 2: playPositionChanged((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        case 3: windowChanged((*reinterpret_cast< qint64(*)>(_a[1])),(*reinterpret_cast< qint64(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 4;
    }
